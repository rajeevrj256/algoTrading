...
/**
 * FnoTradeLogEntity — closed F&O (index option) trades. Mirrors TradeLogEntity but
 * persists to the separate fno_trade_log table so equity and F&O history stay isolated.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Entity
@Table(name = "fno_trade_log")
public class FnoTradeLogEntity {
